//
//  _MDPPagedFavoriteContentModel.m
//  MDPClient
//
...
// Make changes to MDPPagedFavoriteContentModel.h instead.

@import CoreData;
#import "NSManagedObject+MDPManagedObject.h"

extern const struct MDPPagedFavoriteContentModelAttributes {
...
} MDPPagedFavoriteContentModelAttributes;

extern const struct MDPPagedFavoriteContentModelRelationships {
	__unsafe_unretained NSString *pagedContentRequest;
	__unsafe_unretained NSString *results;
} MDPPagedFavoriteContentModelRelationships;

@class MDPPagedFavoriteContentRequestModel;
@class MDPFavoriteContentModel;

@interface _MDPPagedFavoriteContentModel : NSManagedObject
...
@property (nonatomic, strong) MDPPagedFavoriteContentRequestModel *pagedContentRequest;

//- (BOOL)validatePagedContentRequest:(id*)value_ error:(NSError**)error_;
...
@interface _MDPPagedFavoriteContentModel (ResultsCoreDataGeneratedAccessors)
- (void)addResults:(NSSet*)value_;
- (void)removeResults:(NSSet*)value_;
- (void)addResultsObject:(MDPFavoriteContentModel*)value_;
- (void)removeResultsObject:(MDPFavoriteContentModel*)value_;
@end

@interface _MDPPagedFavoriteContentModel (CoreDataGeneratedPrimitiveAccessors)
...
- (MDPPagedFavoriteContentRequestModel*)primitivePagedContentRequest;
- (void)setPrimitivePagedContentRequest:(MDPPagedFavoriteContentRequestModel*)value;
