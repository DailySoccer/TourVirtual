//
//  _MDPPublicGamificationStatusModel.m
//  MDPClient
//
...
// Make changes to MDPPublicGamificationStatusModel.h instead.

@import CoreData;
#import "NSManagedObject+MDPManagedObject.h"

extern const struct MDPPublicGamificationStatusModelAttributes {
	__unsafe_unretained NSString *achievements;
	__unsafe_unretained NSString *areFriends;
...
} MDPPublicGamificationStatusModelAttributes;

@interface _MDPPublicGamificationStatusModel : NSManagedObject
...
@property (nonatomic, strong) NSNumber* areFriends;

@property (atomic) BOOL areFriendsValue;
- (BOOL)areFriendsValue;
- (void)setAreFriendsValue:(BOOL)value_;

//- (BOOL)validateAreFriends:(id*)value_ error:(NSError**)error_;
...
@interface _MDPPublicGamificationStatusModel (CoreDataGeneratedPrimitiveAccessors)
...
- (NSNumber*)primitiveAreFriends;
- (void)setPrimitiveAreFriends:(NSNumber*)value;

- (BOOL)primitiveAreFriendsValue;
- (void)setPrimitiveAreFriendsValue:(BOOL)value_;
