//
//  _MDPBasketSeasonCompetitionPlayerStatisticsModel.m
//  MDPClient
//
...
// Make changes to MDPBasketSeasonCompetitionPlayerStatisticsModel.h instead.

@import CoreData;
#import "NSManagedObject+MDPManagedObject.h"

extern const struct MDPBasketSeasonCompetitionPlayerStatisticsModelAttributes {
...
} MDPBasketSeasonCompetitionPlayerStatisticsModelAttributes;

extern const struct MDPBasketSeasonCompetitionPlayerStatisticsModelRelationships {
	__unsafe_unretained NSString *playerStatisticsRequest;
} MDPBasketSeasonCompetitionPlayerStatisticsModelRelationships;

@class MDPBasketSeasonCompetitionPlayerStatisticsRequestModel;

@interface _MDPBasketSeasonCompetitionPlayerStatisticsModel : NSManagedObject
...
@property (nonatomic, strong) MDPBasketSeasonCompetitionPlayerStatisticsRequestModel *playerStatisticsRequest;

//- (BOOL)validatePlayerStatisticsRequest:(id*)value_ error:(NSError**)error_;

@end

@interface _MDPBasketSeasonCompetitionPlayerStatisticsModel (CoreDataGeneratedPrimitiveAccessors)
...
- (MDPBasketSeasonCompetitionPlayerStatisticsRequestModel*)primitivePlayerStatisticsRequest;
- (void)setPrimitivePlayerStatisticsRequest:(MDPBasketSeasonCompetitionPlayerStatisticsRequestModel*)value;
