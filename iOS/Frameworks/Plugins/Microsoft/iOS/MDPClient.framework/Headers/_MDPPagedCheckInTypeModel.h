...
// Make changes to MDPPagedCheckInTypeModel.h instead.

@import CoreData;
#import "NSManagedObject+MDPManagedObject.h"

extern const struct MDPPagedCheckInTypeModelAttributes {
...
} MDPPagedCheckInTypeModelAttributes;

extern const struct MDPPagedCheckInTypeModelRelationships {
	__unsafe_unretained NSString *pagedCheckInTypeRequest;
	__unsafe_unretained NSString *results;
} MDPPagedCheckInTypeModelRelationships;

@class MDPPagedCheckInTypeRequestModel;
@class MDPCheckInTypeModel;

@interface _MDPPagedCheckInTypeModel : NSManagedObject
...
@property (nonatomic, strong) MDPPagedCheckInTypeRequestModel *pagedCheckInTypeRequest;

//- (BOOL)validatePagedCheckInTypeRequest:(id*)value_ error:(NSError**)error_;
...
@interface _MDPPagedCheckInTypeModel (ResultsCoreDataGeneratedAccessors)
- (void)addResults:(NSSet*)value_;
- (void)removeResults:(NSSet*)value_;
- (void)addResultsObject:(MDPCheckInTypeModel*)value_;
- (void)removeResultsObject:(MDPCheckInTypeModel*)value_;
@end

@interface _MDPPagedCheckInTypeModel (CoreDataGeneratedPrimitiveAccessors)
...
- (MDPPagedCheckInTypeRequestModel*)primitivePagedCheckInTypeRequest;
- (void)setPrimitivePagedCheckInTypeRequest:(MDPPagedCheckInTypeRequestModel*)value;
