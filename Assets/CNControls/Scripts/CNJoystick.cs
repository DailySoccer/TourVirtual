...
public class CNJoystick : CNAbstractController
{
    ...
    protected virtual void Update()
    {
        ...
        if (IsTouchCaptured(out currentTouch)) {
            ...
            _stickGameObject.GetComponent<SpriteRenderer>().enabled = false;
            _baseGameObject.GetComponent<SpriteRenderer>().enabled = false;
        }
    }
    ...
    protected override void TweakControl(Vector2 touchPosition)
    {
        ...
        if (differenceVector.sqrMagnitude > DragRadius * DragRadius)
        {
    ...
    protected virtual void PlaceJoystickBaseUnderTheFinger(Touch touch)
    {
        ...
        _stickGameObject.GetComponent<SpriteRenderer>().enabled = true;
        _baseGameObject.GetComponent<SpriteRenderer>().enabled = true;
    }
