...
// Make changes to MDPPagedOpenThreadsModel.h instead.

@import CoreData;
#import "NSManagedObject+MDPManagedObject.h"

extern const struct MDPPagedOpenThreadsModelAttributes {
...
} MDPPagedOpenThreadsModelAttributes;

extern const struct MDPPagedOpenThreadsModelRelationships {
	__unsafe_unretained NSString *pagedOpenThreadsRequest;
	__unsafe_unretained NSString *results;
} MDPPagedOpenThreadsModelRelationships;

@class MDPPagedOpenThreadsRequestModel;
@class MDPOpenThreadModel;

@interface _MDPPagedOpenThreadsModel : NSManagedObject
...
@property (nonatomic, strong) MDPPagedOpenThreadsRequestModel *pagedOpenThreadsRequest;

//- (BOOL)validatePagedOpenThreadsRequest:(id*)value_ error:(NSError**)error_;
...
@interface _MDPPagedOpenThreadsModel (ResultsCoreDataGeneratedAccessors)
- (void)addResults:(NSOrderedSet*)value_;
- (void)removeResults:(NSOrderedSet*)value_;
- (void)addResultsObject:(MDPOpenThreadModel*)value_;
- (void)removeResultsObject:(MDPOpenThreadModel*)value_;
@end

@interface _MDPPagedOpenThreadsModel (CoreDataGeneratedPrimitiveAccessors)
...
- (MDPPagedOpenThreadsRequestModel*)primitivePagedOpenThreadsRequest;
- (void)setPrimitivePagedOpenThreadsRequest:(MDPPagedOpenThreadsRequestModel*)value;
