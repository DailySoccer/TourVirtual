//
//  _MDPPagedAchievementConfigurationTypeModel.m
//  MDPClient
//
...
// Make changes to MDPPagedAchievementConfigurationTypeModel.h instead.

@import CoreData;
#import "NSManagedObject+MDPManagedObject.h"

extern const struct MDPPagedAchievementConfigurationTypeModelAttributes {
...
} MDPPagedAchievementConfigurationTypeModelAttributes;

extern const struct MDPPagedAchievementConfigurationTypeModelRelationships {
	__unsafe_unretained NSString *pagedAchievementConfigurationTypeRequest;
	__unsafe_unretained NSString *results;
} MDPPagedAchievementConfigurationTypeModelRelationships;

@class MDPPagedAchievementConfigurationTypeRequestModel;
@class MDPAchievementConfigurationTypeModel;

@interface _MDPPagedAchievementConfigurationTypeModel : NSManagedObject
...
@property (nonatomic, strong) MDPPagedAchievementConfigurationTypeRequestModel *pagedAchievementConfigurationTypeRequest;

//- (BOOL)validatePagedAchievementConfigurationTypeRequest:(id*)value_ error:(NSError**)error_;
...
@interface _MDPPagedAchievementConfigurationTypeModel (ResultsCoreDataGeneratedAccessors)
- (void)addResults:(NSSet*)value_;
- (void)removeResults:(NSSet*)value_;
- (void)addResultsObject:(MDPAchievementConfigurationTypeModel*)value_;
- (void)removeResultsObject:(MDPAchievementConfigurationTypeModel*)value_;
@end

@interface _MDPPagedAchievementConfigurationTypeModel (CoreDataGeneratedPrimitiveAccessors)
...
- (MDPPagedAchievementConfigurationTypeRequestModel*)primitivePagedAchievementConfigurationTypeRequest;
- (void)setPrimitivePagedAchievementConfigurationTypeRequest:(MDPPagedAchievementConfigurationTypeRequestModel*)value;
