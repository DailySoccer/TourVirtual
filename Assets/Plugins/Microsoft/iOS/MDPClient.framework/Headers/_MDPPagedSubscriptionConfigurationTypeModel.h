//
//  _MDPPagedSubscriptionConfigurationTypeModel.m
//  MDPClient
//
...
// Make changes to MDPPagedSubscriptionConfigurationTypeModel.h instead.

@import CoreData;
#import "NSManagedObject+MDPManagedObject.h"

extern const struct MDPPagedSubscriptionConfigurationTypeModelAttributes {
...
} MDPPagedSubscriptionConfigurationTypeModelAttributes;

extern const struct MDPPagedSubscriptionConfigurationTypeModelRelationships {
	__unsafe_unretained NSString *pagedSubscriptionConfigurationTypeRequest;
	__unsafe_unretained NSString *results;
} MDPPagedSubscriptionConfigurationTypeModelRelationships;

@class MDPPagedSubscriptionConfigurationTypeRequestModel;
@class MDPSubscriptionConfigurationTypeModel;

@interface _MDPPagedSubscriptionConfigurationTypeModel : NSManagedObject
...
@property (nonatomic, strong) MDPPagedSubscriptionConfigurationTypeRequestModel *pagedSubscriptionConfigurationTypeRequest;

//- (BOOL)validatePagedSubscriptionConfigurationTypeRequest:(id*)value_ error:(NSError**)error_;
...
@interface _MDPPagedSubscriptionConfigurationTypeModel (ResultsCoreDataGeneratedAccessors)
- (void)addResults:(NSSet*)value_;
- (void)removeResults:(NSSet*)value_;
- (void)addResultsObject:(MDPSubscriptionConfigurationTypeModel*)value_;
- (void)removeResultsObject:(MDPSubscriptionConfigurationTypeModel*)value_;
@end

@interface _MDPPagedSubscriptionConfigurationTypeModel (CoreDataGeneratedPrimitiveAccessors)
...
- (MDPPagedSubscriptionConfigurationTypeRequestModel*)primitivePagedSubscriptionConfigurationTypeRequest;
- (void)setPrimitivePagedSubscriptionConfigurationTypeRequest:(MDPPagedSubscriptionConfigurationTypeRequestModel*)value;
